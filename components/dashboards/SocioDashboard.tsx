      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
               <section className="bg-surface-container-low rounded-lg p-6 ghost-border border-t-4 border-t-primary-container">
                  <h3 className="font-headline font-bold text-xl uppercase tracking-tight mb-4 flex items-center gap-2">
                     <span className="material-symbols-outlined text-primary">qr_code_2</span> Mi Acceso
                  </h3>
                  <div className="bg-white p-4 rounded aspect-square flex items-center justify-center">
                     <div className="border-4 border-black border-dashed w-3/4 h-3/4 flex items-center justify-center font-label text-black font-bold">QR CODE</div>
                  </div>
                  <p className="font-label text-[10px] text-center text-tertiary mt-4 uppercase tracking-[0.2em]">Escanea para ingresar</p>
               </section>
            </div>
         </div>
      </main>
